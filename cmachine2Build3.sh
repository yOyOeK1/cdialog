...
bSrc="cnn_config_data.c cmTools.c cmInits.c cmCanvas.c cmMath.c cmTime.c timeh.c ckeyh.c cmdh.c ctermh.c ccanvas.c cargs.c cpostprocess.c mqtth.c cmachine2.c"
inc=""
libsDir=""
libs="-lm"
