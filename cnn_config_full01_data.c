//#FOR_COMPILER_MODULES_DO CM_DO_INIT_KEYBIND CM_DO_INIT_CANVAS CM_DO_INIT_MQTT CM_DO_INIT_KEYBIND CM_DO_INIT_TCPSERVER CM_DO_INIT_WSSERVER CM_DO_INIT_NCURSES CM_DO_INIT_NUDLES
...
char *cnn_target = "cmachine2full001";
